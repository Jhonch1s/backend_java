...
<main class="layout__content">
    <section class="view card form-card membresia-registrar">
        <header class="view__header card__header">
            <a href="javascript:history.back()" class="breadcrumb__link u-mb-16">← Volver a la lista</a>
        ...
        <div class="card__body">Este cliente ya tiene una membresía registrada. Puede <a href="a">renovarla</a> o <a href="b">cambiarla</a>.</div>
