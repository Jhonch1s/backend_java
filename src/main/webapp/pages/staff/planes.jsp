                        ...
                        <c:forEach var="p" items="${listaPlanes}">
                            <tr class="fila-plan"
                                ...
                                <td class="u-text-right">
                                    ...
                                    <button class="btn btn--peligro btn--estado" title="${p.estado ? 'Desactivar' : 'Activar'}">
                                        Cambiar estado
                                    </button>
                                </td>
                            </tr>
    ...
    <div class="modal__contenido borde-redondeado sombra-suave tarjeta">
        ...
        <form id="formNuevo" action="${pageContext.request.contextPath}/staff/planes" method="post" novalidate
            ...
            <div class="group-2">
                ...
                <label>Precio ($)
                    <input type="number" step="0.01" min="0" name="valor" class="plan-create__control"
                           placeholder="0.00" required>
                </label>
            </div>
            <div class="group-2">
                <label>Cantidad
                    <input type="number" min="1" step="1" name="cantidad" class="plan-create__control" value="1"
                           required>
                </label>
                <label>Unidad
    ...
    <div class="modal__contenido borde-redondeado sombra-suave tarjeta">
        ...
        <form id="formEditar" action="${pageContext.request.contextPath}/staff/planes" method="post" novalidate
            ...
            <div class="group-2">
                ...
                <label>Precio ($)
                    <input type="number" step="0.01" min="0" name="valor" id="editValor" class="plan-create__control"
                           required>
                </label>
            </div>
            <div class="group-2">
                <label>Cantidad
                    <input type="number" min="1" step="1" name="cantidad" id="editCantidad" class="plan-create__control"
                           required>
                </label>
                <label>Unidad
