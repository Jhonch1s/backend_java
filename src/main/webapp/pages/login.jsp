...
<head>
    ...
    <link rel="stylesheet" href="/ApiWeb/assets/css/utilidades.css">
    <link rel="stylesheet" href="/ApiWeb/assets/css/style.css">
</head>
    ...
    <main class="login contenedor-pantalla alinear-centro">
        <section class="login__tarjeta sombra-suave borde-redondeado p-3">
            <header class="login__encabezado alinear-centro-column gap-2">
                ...
                <img class="login__logo" src="../assets/img/icon2.svg" alt="Golden Gym">
            </header>

            <form class="login__formulario mt-3" id="form-login" action="#" method="POST" novalidate>
                <div class="login__campo">
                    ...
                    <input class="login__input" type="text" id="usuario" name="usuario" inputmode="numeric"
                        placeholder="Cédula de identidad" autocomplete="username" required
