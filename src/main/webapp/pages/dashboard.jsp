            ...
            <ul>
                <li>
                    <form action="${pageContext.request.contextPath}/logout" method="post">
                        <button type="submit" class="btn boton-primario btn--primary btn--xl u-w-full logout-button">🔒 Cerrar sesión</button>
                    </form>
                </li>
            </ul>
        </nav>
...
<template id="tpl-cliente-crear">
    <section class="view plan-create">
        ...
        <!-- nuevo cliente-->
        <form class="plan-create__form" action="${pageContext.request.contextPath}/clientes" method="post" novalidate>
